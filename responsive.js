...
ready(function() {
    ...
    if (typeof window.nav === 'function') {
        ...
        window.nav = function(id) {
            origNav(id);
            updatePhoneNav(id);
            // When entering messenger on phone, show contact list only if on AI tab
            if (id === 'messenger' && window.CAI_DEVICE === 'phone' && (!window.CAI || window.CAI._msgTab === 'ai' || !window.CAI._msgTab)) {
